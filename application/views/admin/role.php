...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <a href="" class="btn btn-primary btn-sm mb-3" data-toggle="modal" data-target="#newRoleModal"><i class="fas fa-plus"></i> Add new Role</a>
          ...
          <?php foreach ($role as $r) : ?>
            <tr>
              ...
              <td>
                ...
                <a href="<?= base_url() ?>menu/deleteMenu/<?= $r['id'] ?>" onclick="return confirm('Are you sure Delete it?')" class="badge badge-danger">Delete</a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
